...
class TestSquare(unittest.TestCase):
    ...
    def test_pep8_conformance_test_square(self):
        """
        Tests that test_square.py file conform to PEP8
        """
        pep8style = pep8.StyleGuide(quiet=True)
    ...
    def test_func_docstrings(self):
        """
        Test if methods docstring documntation exist
        """
    ...
    def test_Normal_values(self):
        """
        Normal value just for width and height
        """
        S1 = Square(1, 2)
        S2 = Square(1, 2, 3)
        S3 = Square(1, 2, 3, 4)
    ...
    def test_inputted_types(self):
        """
        Difference types for inputted arguments
        """
        with self.assertRaises(TypeError):
