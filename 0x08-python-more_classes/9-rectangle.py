...
# -*- coding: utf-8 -*-
"""
Created on Tue July 04 22:28:14 2023
...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        """
        Initilizer method for Rectangle
    ...
    def height(self):
        """
        getter Property height to retrieve it
    ...
    def square(cls, size=0):
        """
        Class method that define a square

        Attributes:
            cls : parameter that points to the class
